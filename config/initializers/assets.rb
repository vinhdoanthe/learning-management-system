...
Rails.application.config.assets.precompile += %w( redeem/index.js )
Rails.application.config.assets.precompile += %w( redeem/index.css )
...
Rails.application.config.assets.precompile += %w( crm/claim.js )
Rails.application.config.assets.precompile += %w( crm/claim.css )
