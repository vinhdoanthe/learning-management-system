...
Rails.application.config.assets.precompile += %w( social_community/sc_student_project.js )
Rails.application.config.assets.precompile += %w( social_community/sc_student_project_detail.js )
