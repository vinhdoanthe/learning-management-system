...
ActiveRecord::Schema.define(version: 2020_03_24_073234) do
  ...
  create_table "redeem_transactions", force: :cascade do |t|
    ...
    t.bigint "redeem_product_id_id"
    t.index ["redeem_product_id"], name: "index_redeem_transactions_on_redeem_product_id"
    t.index ["redeem_product_id_id"], name: "index_redeem_transactions_on_redeem_product_id_id"
    t.index ["student_id"], name: "index_redeem_transactions_on_student_id"
    t.index ["student_id_id"], name: "index_redeem_transactions_on_student_id_id"
  end
  ...
  add_foreign_key "reactions", "users", column: "user_id_id"
  ...
  add_foreign_key "redeem_transactions", "op_student", column: "student_id_id"
  add_foreign_key "redeem_transactions", "redeem_products", column: "redeem_product_id_id"
