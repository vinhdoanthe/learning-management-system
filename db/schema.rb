...
ActiveRecord::Schema.define(version: 2020_06_10_021200) do
  ...
  create_table "op_admission", id: :serial, comment: "Admission", force: :cascade do |t|
    ...
    t.integer "parrent_partner_id", comment: "Customer"
  ...
  create_table "student_course_admission", id: :serial, comment: "student.course.admission", force: :cascade do |t|
    ...
    t.index ["batch_id", "admission_id"], name: "unique_batch_admission", unique: true
  end
  ...
  create_table "student_project_playlists", force: :cascade do |t|
    t.integer "batch_id"
  ...
  create_table "student_test_room", id: :serial, comment: "Student Test Rooms", force: :cascade do |t|
    ...
    t.string "room_type", null: false, comment: "Room Type"
    t.integer "slot", null: false, comment: "Slot"
    t.boolean "avalible", comment: "avalible"
    t.integer "faculty_id", comment: "Faculty"
    t.integer "user_id", comment: "Assigned to"
  ...
  create_table "student_test_timing", id: :serial, comment: "Period", force: :cascade do |t|
    t.string "name", limit: 128, comment: "Name"
    t.string "hour", null: false, comment: "Hours"
    t.string "minute", null: false, comment: "Minute"
    t.float "duration", comment: "Duration"
    t.string "am_pm", null: false, comment: "AM/PM"
  ...
  add_foreign_key "op_admission", "op_subject", column: "start_subject_id", name: "op_admission_start_subject_id_fkey", on_delete: :nullify
  ...
  add_foreign_key "op_admission", "res_partner", column: "parrent_partner_id", name: "op_admission_parrent_partner_id_fkey", on_delete: :nullify
  ...
  add_foreign_key "student_course_admission", "op_subject", column: "start_subject_id", name: "student_course_admission_start_subject_id_fkey", on_delete: :nullify
